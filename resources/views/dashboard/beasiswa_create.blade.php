    ...
    <div class="row">
        ...
        <div class="offset-lg-2 offset-2 col-lg-8 col-8">
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="post" action="{{route('dashboard.beasiswa.store')}}">
                    {{csrf_field()}}
                    <div class="card-body">
                        <div class="form-group">
                            <label for="namaBeasiswa">Nama Beasiswa</label>
                            <input type="text" class="form-control" id="namaBeasiswa" placeholder="Nama beasiswa" name="nama">
                        </div>
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi</label>
                            <textarea type="text" class="form-control" id="deskripsi" placeholder="Deskripsi Beasiswa" name="deskripsi"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control float-right datetimepicker datetimepicker-input" name="tglbuka" id="tglbuka" data-toggle="datetimepicker" data-target="#tglbuka">
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control float-right datetimepicker datetimepicker-input" name="tgltutup" id="tgltutup" data-toggle="datetimepicker" data-target="#tgltutup">
                            </div>
                            <!-- /.input group -->
                        </div>
                        <div class="form-group">
                            <label for="info">Informasi Tambahan</label>
                            <textarea type="text" class="form-control" id="info" placeholder="Informasi Tambahan" name="infotambahan"></textarea>
                        </div>
                        <div class="form-group">
