                            ...
                            @if($persyaratan)
                                <ul>
                                    @foreach($persyaratan as $key=>$item)
                                        <li>
                                            {{$item['nama']}}
                                            <input type="text" class="form-control mt-1 mb-1" id="ketpersyaratan{{$key}}" name="persyaratan[{{$key}}][keterangan]" placeholder="Tambahkan keterangan" value="{{$item['keterangan']}}">
                            ...
                            @if($fasilitas)
                                <ul>
                                    @foreach($fasilitas as $key=>$item)
                                        <li>
                                            {{$item['nama']}}
                                            <input type="text" class="form-control mt-1 mb-1" id="ketfasilitas{{$key}}" name="fasilitas[{{$key}}][keterangan]" placeholder="Tambahkan keterangan"  value="{{$item['keterangan']}}">
