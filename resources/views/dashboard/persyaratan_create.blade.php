        ...
        <div class="offset-lg-2 offset-2 col-lg-8 col-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Tambah Persyaratan Baru</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{route('dashboard.persyaratan.store')}}">
                    {{csrf_field()}}
                    <div class="card-body">
                        <div class="form-group">
                            <label for="namaPersyaratan">Persyaratan</label>
                            <input type="text" class="form-control" id="namaPersyaratan" name="persyaratan" placeholder="Isi persyaratan">
                        </div>
                    </div>
                    <!-- /.card-body -->
